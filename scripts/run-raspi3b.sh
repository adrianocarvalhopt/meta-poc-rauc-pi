...
DEPLOY_DIR="tmp/deploy/images/raspberrypi3-64"

export MACHINE="raspi3b"
export MEMORY="1G"
export KERNEL_FILE="$DEPLOY_DIR/u-boot.bin"
export DTB_FILE="$DEPLOY_DIR/bcm2710-rpi-3-b.dtb"
export BOOTARGS="\
...
export WIC_FILE="$DEPLOY_DIR/core-image-minimal-raspberrypi3-64.rootfs.wic"
